 ...
 *
 */
public class AsyncCurrentUserHasInvest extends AsyncTaskBase{
	...
	public AsyncCurrentUserHasInvest(Context context, String userId, String borrowId,
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
			url = URLGenerator.getInstance().getCurrentUserHasInvest(userId, borrowId);
			if (result == null) {
